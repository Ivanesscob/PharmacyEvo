...
namespace PharmacyEvo.Pages
{
    ...
    public partial class CountriesPage : Page
    {
        ...
        {
            GlobalClass.MainFrame?.Navigate(new AddEditCountryPage());
        }
        ...
        private void EditButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                GlobalClass.MainFrame?.Navigate(new AddEditCountryPage(SelectedItem));
            }
            else
            {
        ...
        private void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            if (SelectedItem != null)
            {
                ...
                {
                    ProcedureDB.DeleteCountry(SelectedItem.CountryId);
                    LoadData();
                }
            }
        }
